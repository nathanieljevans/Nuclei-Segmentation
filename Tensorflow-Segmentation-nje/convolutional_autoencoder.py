...
class Dataset:
    def __init__(self, batch_size, folder=('data300_300')):
...
#            print(target_image)
            ...
            test_image = np.array(misc.imread(input_image, mode='P'))  # load grayscale
            # test_image = np.multiply(test_image, 1.0 / 255)
            inputs.append(test_image)

            target_image = misc.imread(target_image, mode='P')
